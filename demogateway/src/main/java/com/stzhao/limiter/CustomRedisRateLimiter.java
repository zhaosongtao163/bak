...
public class CustomRedisRateLimiter extends AbstractRateLimiter<CustomRedisRateLimiter.Config>
	...
	/**
	 * This creates an instance with default static configuration, useful in Java
	 * DSL.
	 * 
	 * @param defaultReplenishRate how many tokens per second in token-bucket
	 *                             algorithm.
	 * @param defaultBurstCapacity how many tokens the bucket can hold in
